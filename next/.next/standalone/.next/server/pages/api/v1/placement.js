...
async function handler(req, res) {
    const filePath = path__WEBPACK_IMPORTED_MODULE_1___default().join(process.cwd(), "public/data/placement.json");
...
var __webpack_exports__ = (__webpack_exec__(60362));
