...
export const ExcursionTitle = styled.div`
  ${({theme}) => css`
    font-family: ${theme.font.family.gothicMedium};
...
export const ExcursionDataBlock = styled.div`
  width: 300px;
`;
export const ExcursionImage = styled.img`
  width: 100%;
  height: 167px;
  object-fit: cover;
  border-radius: 32px;
...
export const ApproveButton = styled(ButtonBasic)`
  width: auto;
  white-space: nowrap;
  font-size: 24px;
`;
